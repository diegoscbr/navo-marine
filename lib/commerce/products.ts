...
export const storefrontProducts: StorefrontProduct[] = [
  {
    ...
    subtitle: "The most accurate instrument on the water Ever.",
    descriptionShort:
      "Atlas 2 is the first sailing instrument capable of dual band, L1 + L5 GNSS reception. Measure positional accuracy in centimeters, only on the Atlas 2.",
    pricing: {
      amountCents: 124900,
      currency: "usd",
      taxIncluded: true,
    ...
    techSpecs: [
      {
        ...
        rows: [
          {
            label: "GNSS",
            value: "25Hz L1 + L5 dual-band multi-constellation receiver",
          },
          {
            label: "Motion",
            value: "3-axis gyroscope and 3-axis accelerometer",
          },
          { label: "Direction", value: "3-axis magnetometer" },
          {
            label: "Environmental",
            value: "Ambient light and temperature sensors",
          },
        ],
      },
      {
        ...
        rows: [
          {
            ...
            value: "High-frequency race telemetry",
          },
          {
            label: "Heading / Heel / Pitch",
            value: "Derived from stabilized fusion stack",
          },
      ...
      },
      {
        ...
        rows: [
          {
            label: "Screen",
            value: "4.4 inch transflective LCD, 320x240, 91ppi",
          },
          {
            label: "Visibility",
            value: "Sunlight-readable with 160 degree viewing cone",
          },
          {
            label: "Lens",
            value:
              "Optically bonded Gorilla Glass with AR + hydrophobic coating",
          },
        ],
      },
      {
        ...
        rows: [
          ...
          {
            label: "Storage",
            value: "256MB integrated storage for onboard logs",
          },
        ],
      },
      {
        ...
        rows: [
          {
            label: "Starting",
            value: "Distance-to-line, time-to-line, time-to-burn",
          },
          {
            label: "Race Tools",
            value: "Countdown timer, shift tracking, stripchart, VMG",
          },
        ],
      },
    ],
