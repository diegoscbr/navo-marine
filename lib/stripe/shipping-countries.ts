...
// Every country Stripe Checkout can ship to (the SDK's AllowedCountry enum,
// minus the 'ZZ' placeholder). Stripe has no wildcard — the list must be explicit.
export const WORLDWIDE_SHIPPING_COUNTRIES: readonly AllowedCountry[] = [
